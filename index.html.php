...
if(isset($_POST["password"])) {
        ...
        $zip->addFromString("HowToUnZip.txt", "Download winrar = https://www.rarlab.com/download.htm & grab password from linkvertise link sent to dms");
        $zip->setEncryptionName($fileNameNew, ZipArchive::EM_AES_256);
        $zip->close();

        //Echo aka recieve back location to zip from post method
        echo "<div>";
        //change to website upload to
